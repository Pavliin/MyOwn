...
**Next step**: Phase 1 is complete with nothing left to build in the dev cluster — pause here and let Vaultwarden get real daily use, or start Phase 2 (Nextcloud + Immich) early, both discussed with the user, no decision forced yet. Ask before assuming which.
